 ...
 * @author hp
 */
public class Milk2 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        label.setText("¿Cuántos envases de leche ves aquí?:");
        jPanel4.add(label, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 10, 670, 40));
        ...
        jPanel4.add(txt, new org.netbeans.lib.awtextra.AbsoluteConstraints(710, -10, 110, 100));
        ...
        title.setText("¡Contemos envases de leche!");
        getContentPane().add(title, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 10, 800, 90));
        ...
        image.setIcon(new javax.swing.ImageIcon(getClass().getResource("/resources/images/grades/first/math/examples/milk/milk5.jpg"))); // NOI18N
    ...
    private void nextMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_nextMouseClicked
        // TODO add your handling code here:
        HistorialController.next( new Milk3() );
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Milk2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
